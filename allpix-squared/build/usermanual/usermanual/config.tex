...
\newcommand{\includemodulesmd}{\def\temp{}\ifx\temp\empty
...
\newcommand{\includeexamplesmd}{\def\temp{}\ifx\temp\empty
...
% Set allpix version
\newcommand{\version}{\lstinline|v1.2+74^gb68d17a3|}
\newcommand{\project}{Allpix}
