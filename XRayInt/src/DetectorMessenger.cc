...
// ********************************************************************
//
/// \file electromagnetic/XRayInt/src/DetectorMessenger.cc
...
:G4UImessenger(),fDetector(Det),
 ...
 fSizeCmd(0)
{ 
  fXrayintDir = new G4UIdirectory("/xrayint/");
  fXrayintDir->SetGuidance("commands specific to this example");
  
  fDetDir = new G4UIdirectory("/xrayint/det/");
  fDetDir->SetGuidance("detector construction");
  
  fMaterCmd = new G4UIcmdWithAString("/xrayint/det/setMat",this);
  fMaterCmd->SetGuidance("Select material of the box.");
  fMaterCmd->SetParameterName("choice",false);
  fMaterCmd->AvailableForStates(G4State_PreInit,G4State_Idle);
  fMaterCmd->SetToBeBroadcasted(false);
  
  fSizeCmd = new G4UIcmdWithADoubleAndUnit("/xrayint/det/setSize",this);
