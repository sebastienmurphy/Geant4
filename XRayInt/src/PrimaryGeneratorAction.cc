...
// ********************************************************************
//
/// \file electromagnetic/XRayInt/src/PrimaryGeneratorAction.cc
...
void PrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
  ...
  //
    G4double halfSize = 0.1*(fDetector->GetSize());
//    G4double halfSize = 0.5*1000; //1000 mm beam spot
  ...
  analysisManager->FillH2(0,y0,z0); //beam spot
